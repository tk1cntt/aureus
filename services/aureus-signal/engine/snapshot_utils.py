...
VALID_ENTRY_METHODS = ("CURRENT", "PULLBACK_50", "OB_EDGE", "EMA_TOUCH", "FIXED_OFFSET", "ENTRY_PIVOT_LIMIT", "ENTRY_FVG_FROM_CHOCH_PIVOT", "FIRST_HIGH_LOW_PIVOT", "FIRST_LOW_HIGH_PIVOT")
