...
STRUCTURAL_TAGS = {
    ...
    "sweep_swept", "sweep_stop_hunt", "sweep_dead", "sweep_broken_pending", "sweep_touched",
    "sweep_swept_bull", "sweep_swept_bear",
    "sweep_stop_hunt_bull", "sweep_stop_hunt_bear",
    "sweep_dead_bull", "sweep_dead_bear",
    "sweep_broken_pending_bull", "sweep_broken_pending_bear",
    "sweep_touched_bull", "sweep_touched_bear",
    "sweep_sweep_bull", "sweep_sweep_bear",
