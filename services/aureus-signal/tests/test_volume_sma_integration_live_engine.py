...
class _FakeDBPool:
    def __init__(self):
        ...
        for i in range(30):
            ...
            # Create a volume spike on the very last candle
            v = 100 if i < 29 else 300
                ...
                (
                    ...
                    [
                        (
                            "1-0",
                            {
                                "t": "1701001800", # Timestamp must be strictly greater than last DB warmup row
                                "type": "CANDLE",
                                "symbol": "XAUUSD",
                                "o": "2050.1",
                                "h": "2052.2",
                                "l": "2048.9",
                                "c": "2051.4",
                                "v": "500", # Explicit spike required by new threshold logic
                                "tf": "M1",
                            },
                        )
                    ],
...
class TestVolumeSMAEnginePathIntegration(unittest.IsolatedAsyncioTestCase):
    async def test_run_signal_engine_emits_volume_sma_in_runtime_loop(self):
        fake_db = _FakeDBPool()
