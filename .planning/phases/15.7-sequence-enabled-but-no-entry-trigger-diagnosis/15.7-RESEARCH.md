...
- `services/aureus-signal/engine/strategies/registry.py`
  - `[PIPELINE][A][on_bar_close][start|no_intent|intent]`
  - `[PIPELINE][B][validate_entry][reject]`
  - `[PIPELINE][C][build_order_plan][invalid_shape|reject|ok|accepted]`
- `services/aureus-signal/engine/orders.py`
  - `[PIPELINE][D][process_triggers][missing_origin_timestamp|duplicate_trace|sl_tp_calc_failed|order_plan_incomplete|new_trade]`
