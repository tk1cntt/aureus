...
## Technical Debt
- **11 pre-existing test failures in `test_sweep_o1.py`** — Tag duplication bug (`sweep_bull` prefix). Not caused by v1.2 but should be fixed.
...
- [ ] **Fix sweep_o1 test tag duplication** — Resolve `sweep_bull` prefix bug.
