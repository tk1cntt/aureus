...
### AC Validation
- [x] **AC 1: Centralized Configuration**: IMPLEMENTED in `pivots.py`.
...
- [x] **AC 3: Removal of Hardcoded Imports**: IMPLEMENTED. `ZigZagPro` is now part of an internal registry.
- [x] **AC 4: No Performance Regression**: VERIFIED. 1.46ms/candle vs 1.43ms baseline is within jitter range.
- [x] **AC 5: Parity Verification**: VERIFIED. Golden Hash matches.

### Task Audit
- [x] **Task 1: Design Internal Engine Switch**: DONE (in `pivots.py`).
- [x] **Task 2: Standardize Imports**: DONE (in `pivots.py`).
- [x] **Task 3: Parity & Regression Test**: DONE.
