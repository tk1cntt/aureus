...
This project is indexed by GitNexus as **Aureus** (8708 symbols, 12277 relationships, 136 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/Aureus/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/Aureus/context` | Codebase overview, check index freshness |
| `gitnexus://repo/Aureus/clusters` | All functional areas |
| `gitnexus://repo/Aureus/processes` | All execution flows |
| `gitnexus://repo/Aureus/process/{name}` | Step-by-step execution trace |
